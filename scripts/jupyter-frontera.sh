...
#
# To submit the job, issue: sbatch scripts/jupyter-frontera.sh -i ./my_image.sif
#
...
#
# sbatch scripts/jupyter-frontera.sh -i ./my_image.sif -e my_env.env
#
# If the .sif file does not exist, the script will attempt to pull it from
# DockerHub, e.g.
#
# sbatch scripts/jupyter-frontera.sh -i ./my_image.sif -u docker://docker/whalesay:latest
#
